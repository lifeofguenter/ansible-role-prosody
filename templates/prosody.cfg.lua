...
sql = {
  driver = "MySQL";
  database = "{{ prosody_mysql_db }}"; -- The database name to use. For SQLite3 this the database filename (relative to the data storage directory).
